...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'D:\FCAI-CU\Second Year-Secend Term\Web Technology\Project\phase 3\backend'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'D:\FCAI-CU\Second Year-Secend Term\Web Technology\Project\phase 3\backend\Scripts\deactivate.nu'
